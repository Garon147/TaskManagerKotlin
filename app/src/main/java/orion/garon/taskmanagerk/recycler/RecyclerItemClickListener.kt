...
class RecyclerItemClickListener(context : Context, recyclerView: RecyclerView, listener : OnItemClickListener) : RecyclerView.OnItemTouchListener {
    ...
    private var mGestureListener : MyGestureListener = MyGestureListener()
    ...
    internal var mGestureDetector: GestureDetector = GestureDetector(context, mGestureListener)
